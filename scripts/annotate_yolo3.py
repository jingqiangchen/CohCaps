...
Options:
    ...
    --source PATH       Source [default: /home/test/mic/data/goodnews/images].
    --output PATH       Output folder [default: /home/test/mic/data/goodnews/objects].
    ...
    --dataset DATASET   Dataset [default: goodnews].
